...
CARDS = {
    ...
    19: {"name": "Granger", "collection": "EXORCIST", "points": 3000, "path": os.path.join(PHOTO_BASE_PATH, "18.jpg")},
    20: {"name": "Chong", "collection": "EXORCIST", "points": 3000, "path": os.path.join(PHOTO_BASE_PATH, "20.jpg")},
    ...
    27: {"name": "Chang'e", "collection": "SANRIO CHARASTERS", "points": 3000, "path": os.path.join(PHOTO_BASE_PATH, "27.jpg")},
    28: {"name": "Floryn", "collection": "SANRIO CHARASTERS", "points": 3000, "path": os.path.join(PHOTO_BASE_PATH, "28.jpg")},
    29: {"name": "Claude", "collection": "SANRIO CHARASTERS", "points": 3000, "path": os.path.join(PHOTO_BASE_PATH, "29.jpg")},
    30: {"name": "Angela", "collection": "SANRIO CHARASTERS", "points": 3000, "path": os.path.join(PHOTO_BASE_PATH, "30.jpg")},
    ...
    65: {"name": "Thamu", "collection": "KUNG FU PANDA", "points": 3000, "path": os.path.join(PHOTO_BASE_PATH, "65.jpg")},
    ...
    120: {"name": "Gusion", "collection": "LEGEND", "points": 3000, "path": os.path.join(PHOTO_BASE_PATH, "120.jpg")},
    121: {"name": "Franco", "collection": "LEGEND", "points": 3000, "path": os.path.join(PHOTO_BASE_PATH, "121.jpg")},
    122: {"name": "Saber", "collection": "LEGEND", "points": 3000, "path": os.path.join(PHOTO_BASE_PATH, "122.jpg")},
    123: {"name": "Miya", "collection": "LEGEND", "points": 3000, "path": os.path.join(PHOTO_BASE_PATH, "123.jpg")},
    124: {"name": "Granger", "collection": "LEGEND", "points": 3000, "path": os.path.join(PHOTO_BASE_PATH, "124.jpg")},
    125: {"name": "Gord", "collection": "LEGEND", "points": 3000, "path": os.path.join(PHOTO_BASE_PATH, "125.jpg")},
    126: {"name": "Alucard", "collection": "LEGEND", "points": 3000, "path": os.path.join(PHOTO_BASE_PATH, "126.jpg")},
    127: {"name": "Lesley", "collection": "LEGEND", "points": 3000, "path": os.path.join(PHOTO_BASE_PATH, "127.jpg")},
    128: {"name": "Valir", "collection": "LEGEND", "points": 3000, "path": os.path.join(PHOTO_BASE_PATH, "128.jpg")},
    129: {"name": "Guinevere", "collection": "LEGEND", "points": 3000, "path": os.path.join(PHOTO_BASE_PATH, "129.jpg")},
    130: {"name": "Lunox", "collection": "LEGEND", "points": 3000, "path": os.path.join(PHOTO_BASE_PATH, "130.jpg")},
    131: {"name": "Freya", "collection": "LEGEND", "points": 3000, "path": os.path.join(PHOTO_BASE_PATH, "131.jpg")},
    132: {"name": "Alpha", "collection": "LEGEND", "points": 3000, "path": os.path.join(PHOTO_BASE_PATH, "132.jpg")},
    133: {"name": "Johnson", "collection": "LEGEND", "points": 3000, "path": os.path.join(PHOTO_BASE_PATH, "133.jpg")},
