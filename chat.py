...
async def _get_leaderboard_message(context: ContextTypes.DEFAULT_TYPE, chat_id: int, view: str, scope: str, page: int = 1) -> Tuple[
    ...
    if scope == 'chat':
        ...
        title = f"⛩️ Топ Евангелий в этом чате ⛩️ {'\n\n📿 Мольба:' if view == 'prayers' else '\n✨ Самые набожные:'}\n<i>*Бот обновляет статистику по чатам. Для того чтоб ваще имя высветилось в «топ чата» вам нужно совершить хотя бы одну молитву</i>"
