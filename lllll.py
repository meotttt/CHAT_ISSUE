...
# --- Общая Конфигурация ---
TOKEN = "8086930010:AAH1elkRFf6497_Ls9-XnZrUeIh_rWyMF5c"  # ЗАМЕНИТЕ НА СВОЙ ТОКЕН!

# --- Конфигурация из первого скрипта (Лависки) ---
# Использование os.path.join для кроссплатформенности и r-строка для Windows путей
PHOTO_BASE_PATH = "issue_chat"
NUM_PHOTOS = 74
...
COLLECTION_MENU_IMAGE_PATH = PHOTO_BASE_PATH / "collection_menu_background.jpg"

# --- Конфигурация из второго скрипта (Брак, Админ, Евангелие) ---
GROUP_CHAT_ID: int = -1002372051836  # ID вашей основной группы @chat_issue
GROUP_USERNAME_PLAIN = "CHAT_ISSUE"  # Имя группы для отображения в сообщениях
AQUATORIA_CHAT_ID: Optional[int] = -1002197024170  # ID группы @aquatoria_chats. ЗАМЕНИТЕ НА АКТУАЛЬНЫЙ ID, ЕСЛИ ЕСТЬ!
# Если бот не является членом этой группы или ID не указан,
# эта проверка будет пропущена.
ADMIN_ID = '2123680656'  # ID администратора
...
# Пример:
PHOTO_DETAILS = {
    1: {"path": PHOTO_BASE_PATH / "1.jpg", "caption": "❤️‍🔥 LOVE IS…\nрай!\n\n🔖…1!"},
    2: {"path": PHOTO_BASE_PATH / "2.jpg", "caption": "❤️‍🔥 LOVE IS…\nкогда вместе!\n\n🔖…2! "},
    3: {"path": PHOTO_BASE_PATH / "3.jpg", "caption": "❤️‍🔥 LOVE IS…\nуметь переглядываться!\n\n🔖…3! "},
    4: {"path": PHOTO_BASE_PATH / "4.jpg", "caption": "❤️‍🔥 LOVE IS…\nбыть на коне!\n\n🔖…4! "},
    5: {"path": PHOTO_BASE_PATH / "5.jpg", "caption": "❤️‍🔥 LOVE IS…\nпочувствовать легкое головокружение!\n\n🔖…5! "},
    6: {"path": PHOTO_BASE_PATH / "6.jpg", "caption": "❤️‍🔥 LOVE IS…\nобнимашки!\n\n🔖…6! "},
    7: {"path": PHOTO_BASE_PATH / "7.jpg", "caption": "❤️‍🔥 LOVE IS…\nне только сахар!\n\n🔖…7! "},
    8: {"path": PHOTO_BASE_PATH / "8.jpg", "caption": "❤️‍🔥 LOVE IS…\nпонимать друг друга без слов!\n\n🔖…8! "},
    9: {"path": PHOTO_BASE_PATH / "9.jpg", "caption": "❤️‍🔥 LOVE IS…\nуметь успокоить!\n\n🔖…9! "},
    10: {"path": PHOTO_BASE_PATH / "10.jpg", "caption": "❤️‍🔥 LOVE IS…\nсуметь удержаться!\n\n🔖…10! "},
    11: {"path": PHOTO_BASE_PATH / "11.jpg", "caption": "❤️‍🔥 LOVE IS…\nне дать себя запутать!\n\n🔖…11! "},
    12: {"path": PHOTO_BASE_PATH / "12.jpg", "caption": "❤️‍🔥 LOVE IS…\nсуметь сохранить секретик!\n\n🔖…12! "},
    13: {"path": PHOTO_BASE_PATH / "13.jpg", "caption": "❤️‍🔥 LOVE IS…\nпод прикрытием\n\n🔖…13! "},
    14: {"path": PHOTO_BASE_PATH / "14.jpg", "caption": "❤️‍🔥 LOVE IS…\nкогда нам по пути!\n\n🔖…14! "},
    15: {"path": PHOTO_BASE_PATH / "15.jpg", "caption": "❤️‍🔥 LOVE IS…\nпрорыв.\n\n🔖…15! "},
    16: {"path": PHOTO_BASE_PATH / "16.jpg", "caption": "❤️‍🔥 LOVE IS…\nзагадывать желание\n\n🔖…16!  "},
    17: {"path": PHOTO_BASE_PATH / "17.jpg", "caption": "❤️‍🔥 LOVE IS…\nлето круглый год!\n\n🔖…17! "},
    18: {"path": PHOTO_BASE_PATH / "18.jpg", "caption": "❤️‍🔥 LOVE IS…\nромантика!\n\n🔖…18! "},
    19: {"path": PHOTO_BASE_PATH / "19.jpg", "caption": "❤️‍🔥 LOVE IS…\nкогда жарко!\n\n🔖…19! "},
    20: {"path": PHOTO_BASE_PATH / "20.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nраскрываться!\n\n🔖…20! "},
    21: {"path": PHOTO_BASE_PATH / "21.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nвыполнять обещания\n\n🔖…21! "},
    22: {"path": PHOTO_BASE_PATH / "22.jpg", "caption": "❤️‍🔥 LOVE IS…\nцирк вдвоем!\n\n🔖…22! "},
    23: {"path": PHOTO_BASE_PATH / "23.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nслышать друг друга!\n\n🔖…23! "},
    24: {"path": PHOTO_BASE_PATH / "24.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nсладость\n\n🔖…24! "},
    25: {"path": PHOTO_BASE_PATH / "25.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nне упустить волну!\n\n🔖…25! "},
    26: {"path": PHOTO_BASE_PATH / "26.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nсказать о важном!\n\n🔖…26! "},
    27: {"path": PHOTO_BASE_PATH / "27.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nискриться!\n\n🔖…27! "},
    28: {"path": PHOTO_BASE_PATH / "28.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nтолько мы вдвоём\n\n🔖…28! "},
    29: {"path": PHOTO_BASE_PATH / "29.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nпервое прикосновение\n\n🔖…29! "},
    30: {"path": PHOTO_BASE_PATH / "30.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nвзять дело в свои руки\n\n🔖…30! "},
    31: {"path": PHOTO_BASE_PATH / "31.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nкогда не важно какая погода\n\n🔖…31! "},
    32: {"path": PHOTO_BASE_PATH / "32.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nуметь прощать!\n\n🔖…32! "},
    33: {"path": PHOTO_BASE_PATH / "33.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nотметиться!\n\n🔖…33! "},
    34: {"path": PHOTO_BASE_PATH / "34.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nпервый поцелуй\n\n🔖…34!"},
    35: {"path": PHOTO_BASE_PATH / "35.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nкогда без интернета! \n\n🔖…35!"},
    36: {"path": PHOTO_BASE_PATH / "36.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nлегкое головокружение\n\n🔖…36!"},
    37: {"path": PHOTO_BASE_PATH / "37.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nпозвонить просто так\n\n🔖…37!"},
    38: {"path": PHOTO_BASE_PATH / "38.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nвсё что нужно\n\n🔖…38!"},
    39: {"path": PHOTO_BASE_PATH / "39.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nто, что создаёшь ты\n\n🔖…39!"},
    40: {"path": PHOTO_BASE_PATH / "40.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nсвобода\n\n🔖…40!"},
    41: {"path": PHOTO_BASE_PATH / "41.jpg",
         "caption": "️‍❤️‍🔥 LOVE IS…\nкогда пробежала искра!\n\n🔖…41!"},
    42: {"path": PHOTO_BASE_PATH / "42.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nизображать недотрогу \n\n🔖…42!"},
    43: {"path": PHOTO_BASE_PATH / "43.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nсварить ему борщ)\n\n🔖…43!"},
    44: {"path": PHOTO_BASE_PATH / "44.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nпотрясать мир \n\n🔖…44!"},
    45: {"path": PHOTO_BASE_PATH / "45.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nкогда он не ангел!\n\n🔖…45!"},
    46: {"path": PHOTO_BASE_PATH / "46.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nпритягивать разных!\n\n🔖…46!"},
    47: {"path": PHOTO_BASE_PATH / "47.jpg",
         "caption": "️‍❤️‍🔥 LOVE IS…\nтепло внутри, когда холодно снаружи \n\n🔖…47!"},
    48: {"path": PHOTO_BASE_PATH / "48.jpg",
         "caption": "️‍❤️‍🔥 LOVE IS…\nделать покупки друг друга\n\n🔖…48!"},
    49: {"path": PHOTO_BASE_PATH / "49.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nнемного колкости\n\n🔖…49!"},
    50: {"path": PHOTO_BASE_PATH / "50.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nкогда тянет магнитом \n\n🔖…50!"},
    51: {"path": PHOTO_BASE_PATH / "51.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nбыть на седьмом небе!\n\n🔖…51!"},
    52: {"path": PHOTO_BASE_PATH / "52.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nты и я\n\n🔖…52!"},
    53: {"path": PHOTO_BASE_PATH / "53.jpg",
         "caption": "️‍❤️‍🔥 LOVE IS…\nкогда купил самое необходимое!\n\n🔖…53!"},
    54: {"path": PHOTO_BASE_PATH / "54.jpg",
         "caption": "️‍❤️‍🔥 LOVE IS…\nкак первый день весны!\n\n🔖…54!"},
    55: {"path": PHOTO_BASE_PATH / "55.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nпоздравить первым!\n\n🔖…55!"},
    56: {"path": PHOTO_BASE_PATH / "56.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nоставить след!\n\n🔖…56!"},
    57: {"path": PHOTO_BASE_PATH / "57.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nмикс чувств!\n\n🔖…57!"},
    58: {"path": PHOTO_BASE_PATH / "58.jpg", "caption": "❤️‍🔥 LOVE IS…\nслучайные порывы!\n\n🔖…58!"},
    59: {"path": PHOTO_BASE_PATH / "59.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nкогда мысли сходятся!\n\n🔖…59!"},
    60: {"path": PHOTO_BASE_PATH / "60.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nпосильная ноша!\n\n🔖…60!"},
    61: {"path": PHOTO_BASE_PATH / "61.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nвыбрать свое сердце!\n\n🔖…61!"},
    62: {"path": PHOTO_BASE_PATH / "62.jpg",
         "caption": "️‍❤️‍🔥 LOVE IS…\nто, что требует заботы!\n\n🔖…62!"},
    63: {"path": PHOTO_BASE_PATH / "63.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nбессонный ночи!\n\n🔖…63!"},
    64: {"path": PHOTO_BASE_PATH / "64.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nбыть на вершине мира\n\n🔖…64!"},
    65: {"path": PHOTO_BASE_PATH / "65.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nисправлять ошибки!\n\n🔖…65!"},
    66: {"path": PHOTO_BASE_PATH / "66.jpg",
         "caption": "️‍❤️‍🔥 LOVE IS…\nлюбоваться друг другом!\n\n🔖…66!"},
    67: {"path": PHOTO_BASE_PATH / "67.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nдарить главное!\n\n🔖…67!"},
    68: {"path": PHOTO_BASE_PATH / "68.jpg",
         "caption": "️‍❤️‍🔥 LOVE IS…\nкогда совсем не холодно!\n\n🔖…68!"},
    69: {"path": PHOTO_BASE_PATH / "69.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nдобавить изюминку!\n\n🔖…69!"},
    70: {"path": PHOTO_BASE_PATH / "70.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nснится друг другу!\n\n🔖…70!"},
    71: {"path": PHOTO_BASE_PATH / "71.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nпикник на двоих!\n\n🔖…71!"},
    72: {"path": PHOTO_BASE_PATH / "72.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nдурачиться, как дети\n\n🔖…72!"},
    73: {"path": PHOTO_BASE_PATH / "73.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nдарить себя!\n\n🔖…73!"},
    74: {"path": PHOTO_BASE_PATH / "74.jpg", "caption": "️‍❤️‍🔥 LOVE IS…\nгорячее сердце!\n\n🔖…74!"},
}
...
def get_user_data(user_id, username):
    ...
    if str(user_id) not in data:
        data[str(user_id)] = {
            ...
            "last_spin_cooldown": COOLDOWN_SECONDS,  # хранит текущий применимый откат
            "current_collection_view_index": 0,  # Для просмотра коллекции
    ...
    try:
        ...
        cursor.execute("""
            CREATE TABLE IF NOT EXISTS marriages (
                ...
                private_message_id INTEGER NULL,
                UNIQUE(initiator_id, target_id) ON CONFLICT REPLACE
            )
        """)
        # Добавляем новый столбец private_message_id, если его нет
        try:
            cursor.execute("ALTER TABLE marriages ADD COLUMN private_message_id INTEGER NULL")
        except sqlite3.OperationalError as e:
            if "duplicate column name: private_message_id" not in str(e):
                logger.warning(f"Ошибка при добавлении столбца private_message_id (возможно, уже существует): {e}")

        conn.commit()
        logger.info(f"База данных '{MARRIAGE_DATABASE_NAME}' инициализирована.")
    except sqlite3.Error as e:
        logger.error(f"Ошибка при инициализации базы данных '{MARRIAGE_DATABASE_NAME}': {e}", exc_info=True)
        if conn:
            conn.rollback()
    finally:
        if conn:
...
def init_admin_db():
    ...
    try:
        ...
        logger.error(f"Ошибка при инициализации базы данных '{ADMIN_DATABASE_NAME}': {e}", exc_info=True)
        if conn:
            conn.rollback()
    finally:
        if conn:
...
def init_gospel_game_db():
    ...
    try:
        ...
        logger.error(f"Ошибка при инициализации базы данных '{GOSPEL_GAME_DATABASE_NAME}': {e}", exc_info=True)
        if conn:
            conn.rollback()
    finally:
        if conn:
...
def save_marriage_user_data(user: User, from_group_chat: bool = False):
    ...
    # Если user_id уже есть, берем его last_message_in_group_at, иначе None
    ...
    try:
        cursor.execute("""
            ...
            ON CONFLICT(user_id) DO UPDATE SET
                ...
                last_name = ?,
                updated_at = ?,
                last_message_in_group_at = COALESCE(?, last_message_in_group_at) -- Обновляем только если передан не NULL
        """, (
...
Optional[int]:
    ...
    current_time = datetime.now().isoformat()
    try:
        # ON CONFLICT REPLACE обновит запись, если пара initiator_id, target_id уже существует
        # Это позволяет "пересоздать" предложение от одного и того же инициатора к той же цели
        # Если же цель уже предложила инициатору, то этот ON CONFLICT не сработает
        cursor.execute("""
            ...
            ON CONFLICT(initiator_id, target_id) DO UPDATE SET
                status = 'pending',
                created_at = ?,
                private_message_id = COALESCE(?, private_message_id), -- Обновляем только если новый private_message_id не NULL
                accepted_at = NULL,
                divorced_at = NULL,
                prev_accepted_at = NULL,
                reunion_period_end_at = NULL
        """, (initiator_id, target_id, chat_id, current_time, private_message_id,
              current_time, private_message_id))
        conn.commit()
...
def update_proposal_private_message_id(proposal_id: int, new_message_id: Optional[int]) -> bool:
    ...
    try:
        cursor.execute("""
            UPDATE marriages SET private_message_id = ?
...
def accept_marriage_proposal_db(proposal_id: int, initiator_id: int, target_id: int) -> bool:
    ...
    reunion_info = get_recent_divorce_for_reunion(initiator_id, target_id)  # Предполагается, что эта функция существует

    accepted_at_to_use = current_time
    prev_accepted_at_to_save = None

    if reunion_info and reunion_info['reunion_period_end_at']:
        reunion_end_dt = datetime.fromisoformat(reunion_info['reunion_period_end_at'])
        if reunion_end_dt > datetime.now():
            logger.info(f"Восстановление брака для {initiator_id} и {target_id}. Используем предыдущий длительности.")
            # Используем prev_accepted_at, если есть, иначе accepted_at
            ...
            prev_accepted_at_to_save = accepted_at_to_use  # Сохраняем как prev_accepted_at для будущего
        else:
...
def reject_marriage_proposal_db(proposal_id: int) -> Optional[dict]:
    ...
    cursor = conn.cursor()
    try:
        cursor.execute("SELECT * FROM marriages WHERE id = ? AND status = 'pending'", (proposal_id,))
...
def cancel_marriage_proposal_db(initiator_id: int, target_id: int) -> Optional[dict]:
    ...
    cursor = conn.cursor()
    try:
        # Находим предложение, где initiator_id является инициатором, а target_id - целью
        cursor.execute("""
        ...
        if proposal:
            ...
            """, (proposal_id,))
            conn.commit()
            # Возвращаем полные данные предложения (или хотя бы id и private_message_id)
            return dict(proposal)
        return None
    except sqlite3.Error as e:
...
def divorce_user_db_confirm(user_id: int) -> Optional[Tuple[int, int]]:
    ...
    try:
        ...
        if marriage_row:
            ...
            # Сохраняем актуальную дату начала брака в prev_accepted_at для возможности восстановления стажа
...
def get_marriage_user_display_name(user_data: Dict) -> str:
    ...
    return f"Пользователь (ID: {user_data.get('user_id', 'N/A')})"


async def format_duration(start_time_str: str) -> str:
...
async def check_command_eligibility(user_id: int, context: ContextTypes.DEFAULT_TYPE) -> Tuple[bool, str]:
    """
    Проверяет, соответствует ли пользователь требованиям для использования команд:
    - Является ли участником @aquatoria_chats (если AQUATORIA_CHAT_ID указан).
    - Иначе: Является ли участником GROUP_CHAT_ID и писал ли там что-то за последний месяц.
    Возвращает (is_eligible, reason_message).
    """
    user_info_for_log = f"user {user_id}"
    try:
        user_tg = await context.bot.get_chat_member(user_id, user_id)  # Getting user object to log username/firstname
        user_info_for_log = f"user {user_id} ({user_tg.user.username or user_tg.user.first_name})"
    except Exception:
        pass  # Ignore if we can't get user info this way

    # 1. Проверка на членство в AQUATORIA_CHAT_ID
    if AQUATORIA_CHAT_ID:
        try:
            aquatoria_member = await context.bot.get_chat_member(AQUATORIA_CHAT_ID, user_id)
            if aquatoria_member.status in ['member', 'administrator', 'creator']:
                logger.info(f"{user_info_for_log} является участником Aquatoria, пропускаем остальные проверки.")
                return True, ""  # Пользователь из Aquatoria, не выводим никаких сообщений
        except Exception as e:
            # Если бот не является админом в AQUATORIA_CHAT_ID или ID чата неверен,
            # мы не можем проверить членство, поэтому продолжаем проверку по GROUP_CHAT_ID.
            logger.debug(f"Не удалось проверить членство в чате Aquatoria для {user_info_for_log}: {e}")

    # 2. Продолжаем проверки для GROUP_CHAT_ID (@CHAT_ISSUE)
    user_data = await asyncio.to_thread(get_marriage_user_data_by_id, user_id)

    # Если пользователь не найден в базе бота, значит он не писал в GROUP_CHAT_ID
    if not user_data or not user_data.get('last_message_in_group_at'):
        logger.info(
            f"{user_info_for_log} не найден в базе брачного бота или нет данных о последнем сообщении в группе.")
        return False, "Чтоб пользоваться командами нужно быть участником @{GROUP_USERNAME_PLAIN} и написать в чат свое любимое слово."

    # Проверка членства в GROUP_CHAT_ID
    try:
        chat_member = await context.bot.get_chat_member(GROUP_CHAT_ID, user_id)
        if chat_member.status not in ['member', 'administrator', 'creator']:
            logger.info(f"{user_info_for_log} не является членом @{GROUP_USERNAME_PLAIN}.")
            return False, "Чтоб пользоваться командами нужно быть участником @{GROUP_USERNAME_PLAIN} и написать в чат свое любимое слово."
    except Exception as e:
        logger.error(f"Ошибка при проверке членства в группе @{GROUP_USERNAME_PLAIN} для {user_info_for_log}: {e}")
        return False, "Чтоб пользоваться командами нужно быть участником @{GROUP_USERNAME_PLAIN} и написать в чат свое любимое слово."

    # Проверка активности в GROUP_CHAT_ID (последнее сообщение не старше 1 месяца)
    last_message_str = user_data['last_message_in_group_at']
    last_message_dt = datetime.fromisoformat(last_message_str)
    one_month_ago = datetime.now() - timedelta(days=30)  # Изменено с 1 недели на 1 месяц

    if last_message_dt < one_month_ago:
        logger.info(f"{user_info_for_log} последнее сообщение в @{GROUP_USERNAME_PLAIN} было более месяца назад.")
        return False, "Чтоб пользоваться командами нужно быть участником @{GROUP_USERNAME_PLAIN} и написать в чат свое любимое слово."

    logger.info(f"{user_info_for_log} прошел(ла) проверку на право использовать команды.")
    return True, ""
...
def update_piety_and_prayer_db(user_id: int, gained_piety: float, last_prayer_time: datetime):
    ...
    conn = sqlite3.connect(GOSPEL_GAME_DATABASE_NAME)
    cursor = conn.cursor()
    last_prayer_time_str = last_prayer_time.isoformat()

    try:
        # Используем SQL-арифметику для атомарного обновления
        cursor.execute('''
            UPDATE users SET 
                prayer_count = prayer_count + 1, 
                total_piety_score = total_piety_score + ?, 
                last_prayer_time = ?
            WHERE user_id = ?
        ''', (gained_piety, last_prayer_time_str, user_id))
...
def update_curse_db(user_id: int, cursed_until: datetime):
    ...
    conn = sqlite3.connect(GOSPEL_GAME_DATABASE_NAME)
    cursor = conn.cursor()
    cursed_until_str = cursed_until.isoformat()
...
async def find_gospel_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not user_data:
        # Если пользователя нет, добавляем его с gospel_found=True
    ...
    last_prayer_time_obj = datetime.fromisoformat(user_data['last_prayer_time']).replace(
        tzinfo=timezone.utc) if user_data.get('last_prayer_time') else None
    cursed_until_obj = datetime.fromisoformat(user_data['cursed_until']).replace(tzinfo=timezone.utc) if user_data.get(
        'cursed_until') else None
...
async def prayer_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    cursed_until = datetime.fromisoformat(cursed_until_str).replace(tzinfo=timezone.utc) if cursed_until_str else None
    ...
    last_prayer_time = datetime.fromisoformat(last_prayer_time_str).replace(
        tzinfo=timezone.utc) if last_prayer_time_str else None
...
async def _get_leaderboard_message(context: ContextTypes.DEFAULT_TYPE, view: str, page: int = 1) -> Tuple[
    ...
    cursor = conn.cursor()
    try:
        # Читаем данные из базы, которая теперь обновляется атомарно
        cursor.execute(
...
# helper: получить user_data без ненужного перезаписывания username владельца
def get_user_data_for_owner(owner_id: int):
    data = load_user_data()
    stored_username = data.get(str(owner_id), {}).get("username")
    # если нет username, передаем пустую строку (get_user_data создаст запись при необходимости)
    return get_user_data(owner_id, stored_username or "")
...
async def my_collection(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # Везде добавляем owner id в callback_data
    keyboard = [
        [InlineKeyboardButton(f"❤️‍🔥 LOVE IS... {total_owned_cards}/{NUM_PHOTOS}", callback_data=f"show_collection_{user_id}")],
        [InlineKeyboardButton("🌙 Достижения", callback_data=f"show_achievements_{user_id}"),
         InlineKeyboardButton("🧧 Жетоны", callback_data=f"buy_spins_{user_id}")],
    ]
...
# --- Обновлённая отправка карточки (теперь требует owner_id) ---
async def send_collection_card(query, user_data, card_id: int, owner_id: int):
    owned_card_ids = sorted([int(cid) for cid in user_data["cards"].keys()])

    if not owned_card_ids:
        # вернём владельцу основное меню
        await my_collection_edit_message(query, owner_id=owner_id)
        return
    ...
    if len(owned_card_ids) > 1:
        nav_buttons.append(InlineKeyboardButton("← Предыдущая", callback_data=f"nav_card_{owner_id}_prev"))
        nav_buttons.append(InlineKeyboardButton("Следующая →", callback_data=f"nav_card_{owner_id}_next"))

    if nav_buttons:
        keyboard.append(nav_buttons)

    keyboard.append([InlineKeyboardButton("Выйти в мою коллекцию", callback_data=f"back_to_main_collection_{owner_id}")])
    reply_markup = InlineKeyboardMarkup(keyboard)
    ...
    try:
        ...
        logger.warning(f"Failed to edit message media for card view: {e}. Attempting to delete old and send new.",
                       exc_info=True)
        try:
...
# --- Обновлённая функция для редактирования основного меню (принимает owner_id) ---
async def my_collection_edit_message(query, owner_id: Optional[int] = None):
    # owner_id по умолчанию — пользователь, который нажал кнопку (но обычно мы передаем owner_id явно)
    if owner_id is None:
        owner_id = query.from_user.id

    # используем безопасный доступ, чтобы не перезаписать username владельца чужим username
    user_data = await asyncio.to_thread(get_user_data_for_owner, owner_id)
    username = user_data.get("username") or f"user_{owner_id}"

    total_owned_cards = len(user_data["cards"])

    keyboard = [
        [InlineKeyboardButton(f"❤️‍🔥 LOVE IS... {total_owned_cards}/{NUM_PHOTOS}", callback_data=f"show_collection_{owner_id}")],
        [InlineKeyboardButton("🌙 Достижения", callback_data=f"show_achievements_{owner_id}"),
         InlineKeyboardButton("🧧 Жетоны", callback_data=f"buy_spins_{owner_id}")],
    ]
    reply_markup = InlineKeyboardMarkup(keyboard)
    ...
    try:
        ...
        logger.warning(f"Failed to edit message to main collection photo: {e}. Attempting to delete old and send new.",
                       exc_info=True)
        try:
            await query.message.delete()
        except Exception as del_e:
...
async def rp_command_template(update: Update, context: ContextTypes.DEFAULT_TYPE, responses: List[str],
    ...
    if not target_user_id and context.args:
        ...
        resolved_target_id = await asyncio.to_thread(get_marriage_user_id_from_username_db, username_arg)
        if resolved_target_id:
            target_user_id = resolved_target_id
            target_user_data = await asyncio.to_thread(get_marriage_user_data_by_id, target_user_id)
            if not target_user_data:  # Если данные пользователя не в Marriage DB, пытаемся получить через Telegram API
                try:
                    target_tg_user = await context.bot.get_chat_member(chat_id, target_user_id)
                    target_user_data = {"user_id": target_tg_user.user.id, "first_name": target_tg_user.user.first_name,
                                        "username": target_tg_user.user.username}
                except Exception as e:
                    logger.warning(
                        f"Не удалось получить данные о целевом пользователе {target_user_id} для RP команды: {e}")
                    pass
        else:
            await update.message.reply_text(
                f"👾 Пользователь '{username_arg}' не найден в базе данных бота. Возможно, он еще не писал в чат.")
            return
...
async def unified_start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    keyboard = [
        [InlineKeyboardButton(f'Вступить в чат 💬', url=f'https://t.me/{GROUP_USERNAME_PLAIN}')],
...
VENCHATSYA_REGEX = re.compile(r"^(венчаться)(?:\s+@(\w+))?$", re.IGNORECASE)
...
async def unified_text_message_handler(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if user and not user.is_bot:
        ...
        # NOTE: Эти команды лучше бы переделать в CommandHandler, чтобы избежать коллизий с обычным текстом.
        # Пока оставляю как было, но с более строгими условиями.
        ...
        # --- Команды Брачного Бота ---
            ...
            is_target_eligible, target_reason = await check_command_eligibility(target_user_id, context)
            ...
            if await asyncio.to_thread(get_active_marriage, initiator_id):
                await context.bot.send_message(chat_id=chat_id,
                                               text="👾 Вы уже состоите в браке и не можете предлагать брак другим. Для этого нужно сначала развестись.",
                                               parse_mode=ParseMode.HTML)
                return

            if await asyncio.to_thread(get_active_marriage, target_user_id):
                await context.bot.send_message(chat_id=chat_id,
                                               text=f"👾 {target_mention} уже состоит в браке, и ему не могут предлагать брак. Для этого нужно сначала развестись.",
                                               parse_mode=ParseMode.HTML)
                return

            # Проверяем, есть ли уже *моё* предложение к ним
            my_proposal_to_them = await asyncio.to_thread(get_initiator_pending_proposal, initiator_id, target_user_id)
            if my_proposal_to_them:
                await context.bot.send_message(chat_id=chat_id,
                                               text=f"👾 Вы уже предложили венчаться {target_mention}. Дождитесь ответа.",
                                               parse_mode=ParseMode.HTML)
                return

            # Проверяем, есть ли *их* предложение ко мне
            their_proposal_to_me = await asyncio.to_thread(get_initiator_pending_proposal, target_user_id, initiator_id)
            if their_proposal_to_me:
                await context.bot.send_message(
                    chat_id=chat_id,
                    text=f"👾 {target_mention} уже предложил(а) венчаться вам. Используйте кнопку 'Да' в сообщении с предложением (в личке от бота). Или введите «предложения»",
                    parse_mode=ParseMode.HTML
                )
                return
            ...
            if await asyncio.to_thread(create_marriage_proposal_db, initiator_id, target_user_id, chat_id,
                ...
                await context.bot.send_message(chat_id=chat_id,
                                               text="❗️ Ваше предложение дойдет до пользователя. Однако злоупотреблять предложениями не стоит ❗️\n\nЕсли ваш избранник не получил предложение, ему нужно будет ввести команду «предложения»",
                                               parse_mode=ParseMode.HTML)
            return
            ...
            if update.message.reply_to_message and update.message.reply_to_message.from_user:
                ...
                if resolved_target_id:
                    ...
                    await context.bot.send_message(chat_id=chat_id,
                                                   text="👾 Пользователь не найден в базе данных бота по указанному юзернейму.",
                                                   parse_mode=ParseMode.HTML)
                    return
            else:
                await context.bot.send_message(chat_id=chat_id,
                                               text="👾 Чтобы отменить предложение, ответьте на сообщение пользователя или укажите его `@username` (например: `Отменитьвенчание @username`).",
                                               parse_mode=ParseMode.HTML)
                return
            ...
            if cancelled_proposal:
                ...
                if private_msg_id:
                    try:
                        ...
                        logger.warning(
                            f"Не удалось отредактировать личное сообщение {target_user_id} об отмене предложения: {e}",
                            exc_info=True)
                        try:
                            await context.bot.send_message(
                                chat_id=target_user_id,
            ...
            for marriage in marriages:
                ...
                start_date_str = marriage['prev_accepted_at'] if marriage['prev_accepted_at'] else marriage[
                    'accepted_at']
                duration = await format_duration(start_date_str)
            ...
            response_text = "💌 <b>Входящие предложения о венчании:</b>\n\n"
            ...
            for proposal in pending_proposals:
                ...
                response_text_for_one_proposal = (
                    f"От: {initiator_mention} (отправлено {datetime.fromisoformat(proposal['created_at']).strftime('%d.%m.%Y %H:%M')})\n"
                )
                keyboard = [
            ...
            if sent_at_least_one:
                # Обновляем/переотправляем сообщения с предложениями в личку, чтобы они были актуальными
                await _resend_pending_proposals_to_target(user.id, context)
            return
...
async def unified_button_callback_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data.startswith("marry_") or data.startswith("divorce_"):
        ...
        for ach in ACHIEVEMENTS:
            if ach["id"] in achieved_ids:
                lines.append(f"✅ {ach['name']} — получено ({ach['reward']['amount']} {('жетонов' if ach['reward']['type']=='spins' else 'жетонов')})")
            else:
        ...
        try:
            ...
            logger.warning(f"Failed to show achievements media: {e}", exc_info=True)
            try:
                await query.message.delete()
            except:
                pass
    ...
    # --- Обработка кнопок Лависки ---
        ...
        owned_card_ids = sorted([int(cid) for cid in
                                 (await asyncio.to_thread(get_user_data, current_user_id, current_user_username))[
                                     "cards"].keys()])
        if not owned_card_ids:
            keyboard = [[InlineKeyboardButton("🧧 Жетоны", callback_data="buy_spins")],
                        [InlineKeyboardButton("🌙 Достижения", callback_data="show_achievements"),                   InlineKeyboardButton("Вернуться в коллекцию", callback_data="back_to_main_collection")]]
            reply_markup = InlineKeyboardMarkup(keyboard)
            message_text = (
                f"🪪 Пользователь: @{current_user_username}\n\n"
                f"🧧 Жетоны: {(await asyncio.to_thread(get_user_data, current_user_id, current_user_username))['spins']}\n"
                f"🧩 Фрагменты: {(await asyncio.to_thread(get_user_data, current_user_id, current_user_username))['crystals']}\n\n"
                f"У вас пока нет ни одной качточки LOVE IS..! Используйте 'лав иска', чтобы получить первую"
            )
            try:
                await query.edit_message_media(
                    media=InputMediaPhoto(media=open(COLLECTION_MENU_IMAGE_PATH, "rb"), caption=message_text),
        ...
        try:
            ...
            logger.warning(f"Failed to edit message media for buy_spins, sending new photo: {e}", exc_info=True)
            try:
                await query.message.delete()
            except:
                pass
